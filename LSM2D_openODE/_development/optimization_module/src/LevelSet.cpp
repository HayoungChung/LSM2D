        ...
        if (points.size() == 2)
        {
            ...
            for (unsigned int i = 0; i < mesh.nNodes; i++)
            {
               ...
               if ( mesh.nodes[i].coord.x == points[0].x && 
                           ...
                           mesh.nodes[i].coord.y <= points[1].y )
                { 
                    mesh.nodes[i].isMasked = false;
                    mesh.nodes[i].isDomain = true;
                }
               else if ( mesh.nodes[i].coord.x == points[1].x && 
                           mesh.nodes[i].coord.y >= points[0].y &&
                           mesh.nodes[i].coord.y <= points[1].y )
                { 
                    mesh.nodes[i].isMasked = false;
               ...
               else if ( mesh.nodes[i].coord.y == points[0].y && 
                          mesh.nodes[i].coord.x >= points[0].x &&
                          mesh.nodes[i].coord.x <= points[1].x )
                {
                    mesh.nodes[i].isMasked = false;
                    mesh.nodes[i].isDomain = true;
                } 
               else if ( mesh.nodes[i].coord.y == points[1].y && 
                          mesh.nodes[i].coord.x >= points[0].x &&
                          mesh.nodes[i].coord.x <= points[1].x )
                {
                    mesh.nodes[i].isMasked = false;
