...
namespace slsm
{
    ...
    public:
         ...
         */
        LevelSet(Mesh&, double moveLimit_ = 0.9, unsigned int bandWidth_ = 6, bool isFixed_ = false);
        ...
        /*! \param mesh_
            ...
            \param isFixed_
                Whether the domain boundary is fixed.
         */
        LevelSet(Mesh&, const std::vector<Hole>&, double moveLimit_ = 0.9,
        ...
        /*! \param mesh_
            ...
            \param isFixed_
                Whether the domain boundary is fixed.
         */
        LevelSet(Mesh&, const std::vector<Coord>&, double moveLimit_ = 0.9,
            unsigned int bandWidth_ = 6, bool isFixed_ = false);
        ...
        LevelSet(Mesh&, const std::vector<Hole>&, const std::vector<Hole>&,
            double moveLimit_ = 0.9, unsigned int bandWidth_ = 6, bool isFixed_ = false);
        ...
        // // WIP ======================================================
        // void computeVelocities(std::vector<Coord>&);
        // void initialiseVelocities(const std::vector<Coord>&);
        ...
        double computeGradient(const unsigned int); // WIP JUL11
        double computeVelocities(const unsigned int); // WIP JUL11
    private:
