...
void Levelset2D::set_optimise(){
    optimise = new Optimise(boundary.points, )
}
...
void Levelset2D::get_lambdaLimits(double* negLambdaLim, double* posLambdaLim){
}

void Levelset2D::compute_bndVel(double* lambdas){
    double* constraintDistances;
