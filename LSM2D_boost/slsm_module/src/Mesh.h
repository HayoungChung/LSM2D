...
namespace slsm
{
    ...
    namespace NodeStatus
    {
        ...
        {
            NONE            = 0,                //!< No status.
            INSIDE          = (1 << 0),         //!< Node lies inside the boundary. 1
            OUTSIDE         = (1 << 1),         //!< Node lies outside the boundary. 2
            BOUNDARY        = (1 << 2),         //!< Node lies on the boundary. 4
    ...
    namespace ElementStatus
    {
        ...
        {
            NONE            = 0,                //!< No status.
            INSIDE          = (1 << 0),         //!< Element is entirely inside the structure. 1 
            OUTSIDE         = (1 << 1),         //!< Element is entirely outside the structure. 2 
            CENTRE_INSIDE   = (1 << 2),         //!< Element centre lies inside the structure. 4 
            CENTRE_OUTSIDE  = (1 << 3),         //!< Element centre lies outside the structure. 8
        };
    }
