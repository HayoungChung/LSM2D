...
## THIS GROUP TESTS THE VALIDITY OF THE MODEL 
import numpy as np 

from openmdao.api import Group, IndepVarComp
from myExplicitComponents import DisplacementComp, ConstraintComp, ObjectiveComp, Callback_objF, Callback_conF #,AreaConstComp, ScaleComp, DispComp
...
class LSM2D_slpGroup(Group):
    ...
    def setup(self):
        ...
        self.connect('inputs_comp.lambdas', 'obj_comp.lambdas')
        self.connect('inputs_comp.lambdas', 'con_comp.lambdas')
        ...
        # objective setup
        comp = Callback_objF(lsm_solver = lsm_solver,)#num_dvs = num_dvs)
        comp.add_objective('objective')
        self.add_subsystem('obj_comp', comp)
